...
class CropCenter(object):
    ...
    DAN: around the center, i.e.: if the h is 5 and th is 1 then the crop is (2,3) which 
    is an even interval around the center.
...
def make_intrinsics_layer(w, h, fx, fy, ox, oy):
    ...
    ox: optical center x
    oy: optical center y
    intrinsics layer is a meshgrid a quarter of the image size calibrated with the given focus and center'''
...
def create_train_validation_loaders(
    dataset, validation_ratio, batch_size, num_workers
):
    """
